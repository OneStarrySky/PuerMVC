namespace PureMVC.Patterns
{
    ...
    public class Facade : IFacade
    {
        ...
        public void NotifyObservers(INotification notification)//OrderSystemEvent.STARTUP
        {
            this.m_view.NotifyObservers(notification);
        }

        public void RegisterCommand(string notificationName, Type commandType)//OrderSystemEvent.STARTUP  StartUpCommand
        {
        ...
        public void SendNotification(string notificationName, object body)//callwaiter  c v.c d
        {
